    ...
    public function init_form_fields()
    {
        $this->form_fields = apply_filters('WC_GSama_Config', [
            ...
            'description' => [
                ...
                'default' => 'ضمانت 10 روزۀ بازگشت 100 درصد وجه',
            ],
            'api_key' => [
                'title' => 'کلید وب سرویس',
                'type' => 'text',
            ...
            'before_payment_description' => [
                ...
                'default' => 'با درگاه پرداخت امن سما می توانید از ضمانت 10 روزه خرید با امکان تعویض کالا یا بازپرداخت سریع وجه در صورت وجود مشکل برخوردار شوید.',
            ],
